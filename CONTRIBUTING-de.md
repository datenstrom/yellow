...
3.  Veröffentliche deine Erweiterung im offiziellen Repository. [Was gibt es?](https://github.com/datenstrom/yellow-extensions/blob/master/README-de.md)

## Wie man in Kontakt kommt 

1. [Beobachte uns auf GitHub](https://github.com/datenstrom/yellow), [Gitter](https://gitter.im/datenstrom/yellow), [Twitter](https://twitter.com/datendesigner), [TeamVideo](https://team.video/datendesigner) oder [sende eine Nachricht](https://datenstrom.se/de/contact/).
