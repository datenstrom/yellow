	...
	createPane: function(id, simple)
	{
		...
		if(id == "yellow-panelogin")
		{
			elementDiv.innerHTML =
				...
				"<p><label for=\"email\">"+this.getText("LoginEmail")+"</label> <input id=\"email\" name=\"email\" maxlength=\"64\" /></p>"+
				"<p><label for=\"password\">"+this.getText("LoginPassword")+"</label> <input id=\"password\" type=\"password\" name=\"password\" maxlength=\"64\" /></p>"+
